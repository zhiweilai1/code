...
const postWorkMessage = Mock.mock(
  '/api/postWorkMessage', 'post', (req, res) => {
    return {
      code: 200,
      data: {
        save: true
...
const postProjectMessage = Mock.mock(
  '/api/postProjectMessage', 'post', (req, res) => {
    return {
      code: 200,
      data: {
        save: true
...
const postEvaluationMessage = Mock.mock(
  '/api/postEvaluationMessage', 'post', (req, res) => {
    return {
      code: 200,
      data: {
        save: true
...
const getApplicationList = Mock.mock(
  '/api/getApplicationList', 'get', (req, res) => {
    return {
      code: 200,
      data: [{
        id: 1,
...
const posteEvaluation = Mock.mock(
  '/api/posteEvaluation', 'post', (req, res) => {
    return {
      code: 200,
      data: {
        isSave: true
...
const getHistoryList = Mock.mock(
  '/api/getHistoryList', 'get', (req, res) => {
    return {
      code: 200,
      data: [{
        id: 1,
...
const about = Mock.mock(
  '/api/about', 'get', (req, res) => {
    return {
      code: 200,
      data: '我们是一家非常棒的平台，相信我们是你最明智的选择',
      message: '查询成功'
    }
  })
const contact = Mock.mock(
  '/api/contact', 'get', (req, res) => {
    return {
      code: 200,
      data: [17610826989, '17610826989@163.com', 'zhiweilai123'],
      message: '查询成功'
    }
  })
export default {
  vehicle, user, banner,
  company, companyDetail, officeDetail, resume, hireList, userMsg, loginYan, registration, getResume, postBaseMessage, getBaseMessage, postTecMessage, postWorkMessage, postProjectMessage, postEvaluationMessage, login, getApplicationList, posteEvaluation, getHistoryList, about, contact
}